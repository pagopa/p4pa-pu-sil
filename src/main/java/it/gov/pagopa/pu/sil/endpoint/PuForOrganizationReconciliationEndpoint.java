...
import it.veneto.regione.pagamenti.ente.PaaSILRegistraPagamentoRisposta;
...
public class PuForOrganizationReconciliationEndpoint {
  ...
  public PivotSILChiediPagatiRiconciliatiRisposta pivotSILChiediPagatiRiconciliati(
    ...
    return handleFault(SilFaults.PIVOT_SYSTEM_ERROR, faultString, request.getCodIpaEnte(), new PivotSILChiediPagatiRiconciliatiRisposta());
  }
  ...
  public PivotSILAutorizzaImportFlussoRendicontazioneRisposta pivotSILAutorizzaImportFlussoRendicontazione(
    ...
    IntestazionePPT intestazionePPT = SoapUtils.unmarshallHeader(header, IntestazionePPT.class);
    String faultString = "pivotSILAutorizzaImportFlussoRendicontazione is an UNSUPPORTED Operation";
    log.error(faultString);
    return handleFault(SilFaults.PIVOT_SYSTEM_ERROR, faultString, intestazionePPT.getCodIpaEnte(), new PivotSILAutorizzaImportFlussoRendicontazioneRisposta());
  }
  ...
  public PivotSILAutorizzaImportFlussoRTRisposta pivotSILAutorizzaImportFlussoRT(
    ...
    IntestazionePPT intestazionePPT = SoapUtils.unmarshallHeader(header, IntestazionePPT.class);
    String faultString = "pivotSILAutorizzaImportFlussoRT is an UNSUPPORTED Operation";
    log.error(faultString);
    return handleFault(SilFaults.PIVOT_SYSTEM_ERROR, faultString, intestazionePPT.getCodIpaEnte(), new PivotSILAutorizzaImportFlussoRTRisposta());
  }
