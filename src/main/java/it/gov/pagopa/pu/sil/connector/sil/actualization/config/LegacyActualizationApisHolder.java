...
import it.gov.pagopa.sil.actualizationlegacy.generated.ApiClient;
...
public class LegacyActualizationApisHolder {
  ...
  public LegacyActualizationApisHolder(ActualizationApiClientConfig clientConfig,
    ...
    if (clientConfig.isPrintBodyWhenError()) {
      restTemplate.setErrorHandler(RestTemplateConfig.bodyPrinterWhenError("SIL-ACTUALIZATION-LEGACY"));
    }
  }
