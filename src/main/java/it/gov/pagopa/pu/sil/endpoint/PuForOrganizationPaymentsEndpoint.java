package it.gov.pagopa.pu.sil.endpoint;
    ...
    public class PuForOrganizationPaymentsEndpoint {
      ...
      public PaaSILChiediAvvisiPendentiRisposta paaSILChiediAvvisiPendenti(
          ...
          @SoapHeader("{http://www.regione.veneto.it/pagamenti/ente/ppthead}intestazionePPT") SoapHeaderElement header) {
        return handleUnsupportedOperation("paaSILChiediAvvisiPendenti is an UNSUPPORTED Operation",
            request.getCodIpaEnte(), new PaaSILChiediAvvisiPendentiRisposta());
      }
      ...
      public PaaSILChiediPosizioniAperteRisposta paaSILChiediPosizioniAperte(
          ...
          @SoapHeader("{http://www.regione.veneto.it/pagamenti/ente/ppthead}intestazionePPT") SoapHeaderElement header) {
        return handleUnsupportedOperation("paaSILChiediPosizioniAperte is an UNSUPPORTED Operation",
            request.getCodIpaEnte(), new PaaSILChiediPosizioniAperteRisposta());
      }
      ...
      public PaaSILChiediStoricoPagamentiRisposta paaSILChiediStoricoPagamenti(
          ...
          @SoapHeader("{http://www.regione.veneto.it/pagamenti/ente/ppthead}intestazionePPT") SoapHeaderElement header) {
        return handleUnsupportedOperation("paaSILChiediStoricoPagamenti is an UNSUPPORTED Operation",
            request.getCodIpaEnte(), new PaaSILChiediStoricoPagamentiRisposta());
      }
      ...
      public PaaSILRegistraPagamentoRisposta paaSILRegistraPagamento(
        ...
        return handleUnsupportedOperation("paaSILRegistraPagamento is an UNSUPPORTED Operation",
            request.getCodIpaEnte(), new PaaSILRegistraPagamentoRisposta());
      }
      ...
      private <T extends Risposta> T handleUnsupportedOperation(String faultString, String idFaultEmitter, T responseObj) {
        ...
        return handleFault(SilFaults.PAA_SYSTEM_ERROR, faultString, idFaultEmitter, responseObj);
      }
