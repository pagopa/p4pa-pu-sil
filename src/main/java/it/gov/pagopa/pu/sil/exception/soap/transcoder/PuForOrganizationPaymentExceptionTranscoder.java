...
public class PuForOrganizationPaymentExceptionTranscoder extends BaseSoapExceptionTranscoder {
  ...
  protected static final Map<String, SilFaults> errorCode2SilFault = Map.of(
    ProcessExecutionsErrorDTO.CategoryEnum.PROCESS_EXECUTIONS_INVALID_FILE_VERSION.getValue(), SilFaults.PAA_VERSIONE_TRACCIATO_NON_VALIDA,
    ProcessExecutionsErrorDTO.CategoryEnum.PROCESS_EXECUTIONS_INVALID_TIME_RANGE.getValue(), SilFaults.PAA_INTERVALLO_DATE_NON_VALIDO
  );
