...
public enum SilFaults {
  ...
  PAA_IUV_NON_VALIDO("IUV non valido", "P4PA_INVALID_IUV"),
  PAA_IUD_NON_VALIDO("IUD non valido"),
  PAA_IDENTIFICATIVO_TIPO_DOVUTO_NON_VALIDO("Identificativo tipo dovuto non valido", "P4PA_MISSING_DEBT_POS_TYPE_ORG"),
  PAA_IDENTIFICATIVO_TIPO_DOVUTO_NON_ABILITATO("Identificativo tipo dovuto non abilitato", "P4PA_DEBT_POS_TYPE_ORG_UNAUTHORIZED"),
  PAA_IUD_DUPLICATO("IUD duplicato"),
  PAA_MARCA_BOLLO_DIGITALE_NON_VALIDA("Marca da bollo digitale non valida"),
  PAA_IMPORTO_SINGOLO_VERSAMENTO_NON_VALIDO("Importo versamento non valido", "P4PA_INVALID_AMOUNT", "P4PA_INVALID_CENTS_AMOUNT"),
  PAA_DATI_SPECIFICI_RISCOSSIONE_NON_VALIDO("Dati specifici riscossione non validi", "P4PA_INVALID_TAXONOMY_CATEGORY", "P4PA_MISSING_TAXONOMY_CATEGORY", "P4PA_INVALID_LEGACY_PAYMENT_METADATA"),
  PAA_IMPORTO_BILANCIO_NON_VALIDO("Importo bilancio non valido", "P4PA_INVALID_BALANCE"),
  PAA_CAUSALE_NON_PRESENTE("Causale non presente o non valida", "P4PA_MISSING_REMITTANCE_INFORMATION"),
  PAA_ANAGRAFICA_NON_VALIDA("Anagrafica debitore non valida", "P4PA_INVALID_PERSONAL_DATA"),
  PAA_XML_NON_VALIDO("XML non valido", "P4PA_INVALID_BALANCE"),
  PAA_CODICE_FISCALE_NON_VALIDO("Codice fiscale non valido", "P4PA_INVALID_FISCAL_CODE", "P4PA_INVALID_VAT_CODE"),
  ...
  PAA_LIMITE_MASSIMO_DOVUTI_MULTIBENEFICIARI("Numero massimo versamenti enti secondari superato", "P4PA_MAX_TRANSFERS"),
  PAA_ENTE_SECONDARIO_NON_VALIDO("Ente secondario non valido", "P4PA_INVALID_IBAN"),
  ...
  PAA_CAMPO_NON_MODIFICABILE("Campo non modificabile", "P4PA_UNMODIFIABLE_FIELD"),
