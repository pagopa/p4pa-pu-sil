...
public enum SilFaults {
  ...
  PAA_DATA_ESECUZIONE_PAGAMENTO_NON_VALIDA("dataEsecuzionePagamento non presente o non valida"),
  PAA_DOVUTO_DUPLICATO("Dovuto già esistente"),
  ...
  PIVOT_TIPO_FLUSSO_NON_VALIDO("Tipo di flusso non valido"),
