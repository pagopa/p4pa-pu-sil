...
public class SilLegacyBasicAuthService {
  ...
  public AccessToken authenticate(RegistryContextData contextData, SilServiceLegacyBasicAuthConfigDTO config) {
    // TODO: transform the Credentials fields properly https://pagopa.atlassian.net/browse/P4ADEV-3126
    Token token = legacyBasicAuthService.login(contextData,
      Credentials.builder()
