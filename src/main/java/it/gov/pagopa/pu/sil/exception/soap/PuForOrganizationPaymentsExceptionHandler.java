...
@Service
public class PuForOrganizationPaymentsExceptionHandler extends BaseSoapExceptionHandler<FaultBean> {


  public PuForOrganizationPaymentsExceptionHandler(PuForOrganizationPaymentExceptionTranscoder exceptionTranscoder) {
