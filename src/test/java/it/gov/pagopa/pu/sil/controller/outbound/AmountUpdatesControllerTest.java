...
import it.gov.pagopa.pu.sil.service.outbound.actualization.ActualizationFacadeService;
...
class AmountUpdatesControllerTest {
  ...
  void whenGetAmountUpdatesThenOk() {
    ...
    when(actualizationFacadeServiceMock.actualize(orgSilServiceId, nav, userInfo, "fakeAccessToken"))
