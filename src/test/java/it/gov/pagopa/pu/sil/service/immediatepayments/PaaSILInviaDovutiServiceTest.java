...
class PaaSILInviaDovutiServiceTest {
  ...
  @BeforeEach
  void setUp() {
    Mockito.reset(paaSILInviaDovutiMapperMock, checkoutServiceMock, manageDebtPositionServiceMock, organizationServiceMock, cartRequestMapperMock, sessionIdMapperMock);
