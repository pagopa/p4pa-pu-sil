...
class PaaSILInviaDovutiServiceTest {
  ...
  @BeforeEach
  void setUp() {
    Mockito.reset(paaSILInviaDovutiMapperMock, checkoutServiceMock, instantPaymentsFacadeMock, organizationServiceMock, cartRequestMapperMock, sessionIdMapperMock);
