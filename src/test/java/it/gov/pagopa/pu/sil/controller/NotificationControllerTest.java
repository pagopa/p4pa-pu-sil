...
class NotificationControllerTest {
  @Mock
  private NotificationRetrieverService notificationRetrieverServiceMock;
  @InjectMocks
  ...
  void givenCreateSendNotificationThenOk() {
    ...
    Mockito.when(notificationRetrieverServiceMock.createSendNotification(
      organizationId,
      request,
      userInfo,
      "fakeAccessToken"
    ...
    ResponseEntity<CreateNotificationResponse> response = notificationController.createSendNotification(organizationId,request);
